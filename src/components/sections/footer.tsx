...
import { Leaf, TreePine, Zap, Shield, MapPin, Phone, Heart } from "lucide-react";

const footerFeatures = [
  { icon: TreePine, text: "Чистый воздух и природа" },
  { icon: Shield, text: "Безопасное и тихое место" },
  { icon: Zap, text: "Инфраструктура в шаге" },
  { icon: Leaf, text: "Экологичность" },
];
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4 sm:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mt-3 max-w-xs text-sm leading-relaxed text-white/40">
              Тихое место для жизни среди соснового леса. Свежий воздух,
              спокойствие, природа.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              {footerFeatures.map((f) => (
                <li key={f.text} className="flex items-center gap-2.5">
                  <f.icon className="h-4 w-4 text-forest-500" />
              ...
              {[
                ...
                <li key={item.href}>
                  <a
                    ...
                    className="text-sm text-white/50 transition-colors hover:text-forest-300"
                  >
                    {item.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="flex items-center gap-2 text-sm font-semibold text-white/70 transition-colors hover:text-forest-300"
                >
            ...
            <div className="mt-6 flex gap-3">
              ...
              <a
                href="#"
                className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/5 text-white/50 transition-all hover:bg-green-500/20 hover:text-green-400"
                aria-label="WhatsApp"
              >
        ...
        <div className="mt-12 border-t border-white/5 pt-6">
          <div className="flex flex-col items-center gap-2 sm:flex-row sm:justify-between">
            <p className="text-xs text-white/30">
              © {new Date().getFullYear()} Дикая Дача. Все права защищены.
            </p>
            <p className="flex items-center gap-1 text-xs text-white/20">
              Сделано с <Heart className="h-3 w-3 text-forest-500" /> к природе
            </p>
          </div>
        </div>
      </div>
