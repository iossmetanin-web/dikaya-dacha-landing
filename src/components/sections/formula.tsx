          ...
          <div className="mx-auto max-w-4xl">
            <div className="flex flex-col items-center gap-6 sm:flex-row sm:justify-center sm:gap-4 lg:gap-6">
              ...
              <div className="glass-card w-full rounded-2xl p-6 text-center transition-all hover:bg-white/10 sm:w-48 sm:p-8">
                <div className="mx-auto mb-3 h-16 w-16 overflow-hidden rounded-xl">
                  <div
                    ...
                    style={{ backgroundImage: "url('/images/plot-2.png')" }}
                  />
                </div>
                <p className="text-sm font-medium text-white/60">Участок</p>
                <p
                  className="mt-1 text-xl font-black text-forest-300 sm:text-2xl"
                  style={{ fontFamily: "var(--font-heading)" }}
                >
                  350 000 ₽
                </p>
              ...
              <div className="glass-card w-full rounded-2xl p-6 text-center transition-all hover:bg-white/10 sm:w-48 sm:p-8">
                <div className="mx-auto mb-3 h-16 w-16 overflow-hidden rounded-xl">
                  <div
                    className="h-full w-full bg-cover bg-center"
                    style={{ backgroundImage: "url('/images/house-1.png')" }}
                  />
                </div>
            ...
            <div className="mt-12 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <button
                ...
                className="glow-green rounded-2xl bg-forest-400 px-8 py-4 text-base font-bold text-forest-950 transition-all hover:bg-forest-300 active:scale-[0.98] sm:text-lg"
              >
              ...
              <button
                ...
                className="rounded-2xl border-2 border-white/30 bg-white/10 px-8 py-4 text-base font-bold text-white transition-all hover:border-white/50 hover:bg-white/20 active:scale-[0.98] sm:text-lg"
              >
                Выбрать участок
              </button>
            </div>
